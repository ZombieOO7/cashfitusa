...
@section('title', __('formname.app.list'))
    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('app.multi_delete')}}"
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth " id="app_table"
                    data-type="" data-table_name="app_table" data-url="{{ route('app.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.app.name')}}"></th>
                                    <th><input type="text" class="form-control form-control-sm tbl-filter-column"
...
@section('inc_script')
<script>
var url = "{{ route('app.datatable') }}";
</script>
<script src="{{ asset('backend/js/app/index.js') }}" type="text/javascript"></script>
@stop