						...
						<div class="m-form__section m-form__section--first">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-6 col-md-9 col-sm-12">
										<div class="input-group">
											...
											m-bootstrap-select ','id'=>'month','multiple'=>false 
											,'data-none-selected-text' => __('formname.report.select_month') ])!!}
										</div>
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-6 col-md-9 col-sm-12">
										<div class="input-group">
											...
											m-bootstrap-select ','id'=>'date','multiple'=>false 
											,'data-none-selected-text' => __('formname.report.select_date') ])!!}
										</div>
								...
								{{-- <div class="form-group m-form__group row">
									...
									<div class="col-lg-6 col-md-9 col-sm-12">
										<div class="input-group">
											{!!Form::select('export_to',@[''=>'Select','.csv'=>'CSV','.xlsx'=>'Excel'],[],['class'=>'form-control','id'=>'export_to'
