                        ...
                        <form method="post" action="{{ route('admin/password/reset') }}" aria-label="{{ __('Login') }}"
                            ...
                            <div class="form-group m-form__group">
                                <label for="email" class="col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
                                    <input id="email" maxlength="{{config('constant.email_length')}}" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $email) }}" required autocomplete="email" autofocus>
                            ...
                            <div class="form-group m-form__group">
                                <label for="password" class="col-form-label text-md-right">{{ __('Password') }}</label>
                                    <input id="password" type="password" maxlength={{config('constant.password_max_length')}} minlength={{config('constant.password_min_length')}} class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <input id="password-confirm" type="password" maxlength={{config('constant.password_max_length')}} minlength={{config('constant.password_min_length')}} class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
