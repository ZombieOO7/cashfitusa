...
@section('title', __('formname.card-transaction.list'))
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                <div class="m-form__content">
                    <h5>{{__('formname.card-transaction.list')}}</h5>
                </div>
                <hr>
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('card-transaction.multi_delete')}}"
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="{{route('card-transaction.create')}}"
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth " id="card_transaction_table"
                    data-type="" data-table_name="card_transaction_table" data-url="{{ route('card-transaction.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
...
@section('inc_script')
<script>
var url = "{{ route('card-transaction.datatable') }}";
</script>
<script src="{{ asset('backend/js/card-transaction/index.js') }}" type="text/javascript"></script>
@stop