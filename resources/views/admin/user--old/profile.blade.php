                                        ...
                                        <div class="tab-pane active" id="profile" role="tabpanel">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    col-lg-3 col-sm-12']) !!}
                                                    <div class="col-lg-2 col-md-9 col-sm-12 col-form-label">
                                                        {!! Form::select('user_type',@$userTypeList,@$user->user_type,['data-id'=>@$user->uuid,'data-url'=>route('user.change-position'),'class' => 'form-control','id'=>'user_type']) !!}
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                ...
                                                @if($user->is_verify == 0)
                                                <div class="form-group m-form__group row">
                                                    {!! Form::label(__('formname.verify_user').' : ',
                                                    null,['class'=>'col-form-label
                                                    col-lg-3 col-sm-12']) !!}
                                                    <div class="col-lg-3 col-md-9 col-sm-12 col-form-label">
                                                        <a href="{{Route('user_verify',[@$user->id,1])}}"
                                                            class="btn btn-success">{{__('formname.verify')}}</a>
                                                        <a href="{{Route('user_verify',[@$user->id,2])}}"
                                                            class="btn btn-danger">{{__('formname.decline')}}</a>
                                                    </div>
                                                </div>
                                                @endif
                                                @if($user->is_verify != 0)
                                                <div class="form-group m-form__group row">
                                                {!! Form::label(__('formname.verified_label').' : ',
                                                    null,['class'=>'col-form-label
                                                    col-lg-3 col-sm-12']) !!}
                                                    <div class="col-lg-3 col-md-9 col-sm-12 col-form-label">
                                                        {{__('formname.verified_status',['status'=>(@$user->is_verify==1)?'verified':'declined'])}}
                                                    </div>
                                                </div>
                                                @endif
                                            </div>
