                ...
                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile"
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                {!! Form::label(__('formname.email'). '*', null,['class'=>'col-form-label
                                col-lg-3
                                col-sm-12']) !!}
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    {!!
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    ...
                                    @endif
                                    @if($user)
                                    @if(file_exists(base_path(@$user->path)) && @$user->path != null)
                                        <img id="blah" src="{{@$user->path_text }}" alt="" height="200px;" width="200px;"
                                        style="display:block;" />
                                    @else
                                        <img id="blah" src="{{asset('images/default.png') }}" alt="" height="200px;" width="200px;"
                                        style="display:block;" />
                                    @endif
                                    @else
