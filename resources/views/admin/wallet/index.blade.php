...
@section('title', __('formname.wallet.list'))
    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('wallet.multi_delete')}}"
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth " id="wallet_table"
                    data-type="" data-table_name="wallet_table" data-url="{{ route('wallet.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
                            ...
                            <th>{{__('formname.wallet_balance')}}</th>
                            <th>{{__('formname.transfer_amount')}}</th>
                            <th>{{__('formname.withdrawal_amount')}}</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th>
                                <input type="text" class="form-control form-control-sm tbl-filter-column" placeholder="{{__('formname.wallet_balance')}}">
                            </th>
                            <th>
                                <input type="text" class="form-control form-control-sm tbl-filter-column" placeholder="{{__('formname.transfer_amount')}}">
                            </th>
                            <th>
                                <input type="text" class="form-control form-control-sm tbl-filter-column" placeholder="{{__('formname.withdrawal_amount')}}">
                            </th>
                            <td></td>
                        </tr>
                    </tfoot>
...
@section('inc_script')
<script>
var url = "{{ route('wallet.datatable') }}";
</script>
<script src="{{ asset('backend/js/wallet/index.js') }}" type="text/javascript"></script>
@stop