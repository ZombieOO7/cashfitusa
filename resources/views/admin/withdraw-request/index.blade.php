...
@section('title', __('formname.withdraw.list'))
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                <div class="m-form__content">
                    <h5>{{__('formname.withdraw.list')}}</h5>
                </div>
                <hr>
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('withdraw.multi_delete')}}"
                                data-table_name="withdraw_table" >{{__('formname.submit')}}</a>
                            <button class="btn btn-info" style='margin:0px 0px 0px 12px' id='clr_filter'
                                data-table_name="withdraw_table" >{{__('formname.clear_filter')}}</button>
                        </div>
                    </div>
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth " id="withdraw_table"
                    data-type="" data-table_name="withdraw_table" data-url="{{ route('withdraw.datatable') }}" >
                    <thead>
                        <tr>
                            <th class="nosort">
                            ...
                            <th>{{__('formname.withdraw.date')}}</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.withdraw.date')}}"></th>
                            <th class="slct-wdth">
...
@section('inc_script')
<script>
var url = "{{ route('withdraw.datatable') }}";
</script>
<script src="{{ asset('backend/js/withdraw/index.js') }}" type="text/javascript"></script>
@stop