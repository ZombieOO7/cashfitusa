            ...
            <div class="m-grid__item m-grid__item--fluid m-login__wrapper">
                <div class="m-login__container">
                    <div class="m-login__logo">
                        <a href="{{ URL('/') }}">
                            <img src="{{ asset('images/logo.png') }}" alt="{{ env('APP_NAME') }}" width="100">
                         ...
                         <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} m-input"type="email" placeholder={{trans("formname.email")}} maxlength="{{config('constant.email_length')}}" name="email" id="email"
                            ...
                            <div class="form-group m-form__group">
                                <input
                                    ...
                                    onchange="return trim(this)" maxlength={{config('constant.password_max_length')}} minlength={{config('constant.password_min_length')}} readonly onfocus="this.removeAttribute('readonly');" />
