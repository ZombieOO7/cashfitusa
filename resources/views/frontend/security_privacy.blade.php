...
<link rel="stylesheet" href="{{asset('/frontend/css/newstyle.css')}}">
    ...
    <div class="container">
        <div class="cmsCon">
            ...
            <b><span>Protected Uses</span></b>
            <ul>
                <li>Rapidcash America receives and uses the details of its clients only when it finds it necessary to perform its business, including the provision of consumer loans.</li>
                <li>Rapidcash America does not exchange customer NPPI or consumer information except as allowed by regulation and disclosed in its privacy notice.</li>
                <li>Rapidcash America takes steps to combat data fraud and prevent fraudulent purchases, through the participation of eligible industry-leading third-party service providers to help with those programs.</li>
                <li>Rapidcash America does business with third parties only if Rapidcash America is sure that those third parties have the necessary practices, protocols and processes in order to follow our stringent protection and privacy requirements.</li>
            </ul>
            <b><span>Privacy Notice</span></b>
            ...
            <b><span>Compliance with State and Federal Laws</span></b>
            ...
            <b><span>Secure System</span></b>
            <ul>
                <li>We use industry-recognized security protections to help protect personally identifying information that you have given to us from deletion, abuse, or unwanted modification. All data submitted to Rapidcash America is secured by code that allows the data to be encrypted. We use, among other things:</li>
                <li>Secure Socket Layer (SSL): Rapidcash America's Web server follows the Secure Socket Layer (SSL) transaction protocol that is widely accepted as an industry standard. This security protocol is in order to keep information exchanged back and forth between a Web server and its users confidential.</li>
                <li> 256-Bit Domestic Grade Strong Encryption: We use 256-Bit Domestic Grade Strong Encryption, a popular encryption technique currently available for Internet devices. You can download 256-bit browsers from Mozilla, Apple or Microsoft for free.</li>
            </ul>
            <h5>Site Access</h5>
            ...
            <ul>
                <li>Finicity Corporation ("Finicity")</li>
                <li>Clarilogic, Inc. dba Decision Logic ("DecisionLogic")</li>
                <li>Plaid Technologies, Inc. ("Plaid")</li>
            </ul>
            ...
            <h5>Application and Dashboard</h5>
            ...
            <h5>Data Collection and Data Sharing</h5>
            ...
            <b><span>Sources of collected data:</span></b>
            <ul>
            ...
            <b><span>Ways we might use your data:</span></b>
<ul>
...
<b><span>Reasons we might share your data with third parties:</span></b>
<ul>
...
<b><span>With your consent, we might share your personal data with third parties, including our affiliates, mortgage partners and service providers, for these reasons:</span></b>
<ul>
    <li>Marketing</li>
    <li>Analytics</li>
    <li>Pre-populating your information to make your experience easier</li>
</ul>
<h5>California Residents: Sections 1.1 – 1.9 Detail Your Rights Under the California Consumer Privacy Act</h5>
<b><span>1.1 Sale of Data</span></b>
...
<b><span>1.4 Right to Access</span></b>
...
<b><span>1.5 Right to Delete</span></b>
<p>You have the right to request that we delete your data. We're legally required to keep some data about you, but we'll delete everything we can. Keep in mind that we might reacquire 
some of your data if we purchase data from a third party.</p>
<b><span>1.6 How We Process Your Privacy Rights</span></b>
