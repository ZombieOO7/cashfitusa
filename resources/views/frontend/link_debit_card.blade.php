            ...
            <div class="formbankmain">
                ...
                <form class="formlinkbank">
                    ...
                    <div class="resubmitmain">
                        <span class="wpcf7-list-item first"><label><input type="checkbox" name="services[]"
                                    value="Web Development"><span class="wpcf7-list-item-label">I here by accept all
                                    <b>Terms &amp; Conditions</b></span></label></span>
                    </div>
                </form>
