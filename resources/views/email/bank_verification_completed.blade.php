		...
		<td align="center">
			<table style="background: #fff" width="600" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff"> 				
					<tbody bgcolor="#ebebeb">
						...
						<tr>
							<td style="padding-bottom:50px; padding-top: 20px;" class="imgPost" valign="top" align="center"><a href="#" style="text-decoration:none"><img alt="banner" src="{{asset('email/banner.png')}}" style="max-width:800px;height:auto;display:block" border="0"></a></td>
						</tr>
						...
						<tr>
							<td style="padding-bottom:150px;padding-left:30px;padding-right:30px;padding-top: 20px;" class="title" valign="top" align="left">
								...
								<p class="midText" style="color:#000;font-family:'Arial';font-size:14px;font-weight:400;line-height:22px;text-align:left;padding:0;margin:0;padding-right: 0px;">Congratulations! We are Happy to inform you that our Rapid Cash America Verification Team has successfully verified your Bank Details and soon the Loan amount will be transferred to your Bank Account</p>
							</td>
						</tr>
