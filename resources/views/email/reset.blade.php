                ...
                <td align="center">
                    <table style="background: #fff" width="600" cellspacing="0" cellpadding="0" border="0"
                        ...
                        <tbody bgcolor="#ebebeb">
                            ...
                            <tr>
                                <td style="padding-bottom:50px; padding-top: 20px;" class="imgPost" valign="top"
                                    align="center"><a href="#" style="text-decoration:none"><img alt="banner"
                                            src="{{ asset('email/forgot-pass-banner.png') }}"
                                            style="max-width:800px;height:auto;display:block" border="0"></a></td>
                            </tr>


                            <tr>
                                <td style="padding-bottom:0px;padding-left:30px;padding-right:30px;padding-top: 20px;"
                                    ...
                                    <p class="midText"
                                        ...
                                        We have received your request for a password reset, which you do here.This link
                            ...
                            <tr>
                                <td style="padding-bottom:0px;padding-left:30px;padding-right:30px;padding-top: 0px;"
                                    valign="top" align="left">
                                    <p class="midText"
                                        style="color:#000;font-family:'Arial';font-size:14px;font-weight:400;line-height:22px;text-align:left;padding:0;margin:0;padding-right: 0px;">
                                        You new password must include:</p>
                                    <ul>
                                        <li
                                            style="color:#000;font-family:'Arial';font-size:14px;font-weight:400;line-height:22px;text-align:left;padding:0;margin:0;">
                                            one uppercase</li>
                                        <li
                                            style="color:#000;font-family:'Arial';font-size:14px;font-weight:400;line-height:22px;text-align:left;padding:0;margin:0;">
                                            one lowercase</li>
                            ...
                            <tr>
                                <td style="padding-bottom: 10px; text-align: center;display: block;">
                            ...
                            <tr>
                                <td style="padding-bottom:0px;padding-left:30px;padding-right:30px;padding-top: 0px;"
                                    ...
                                    <p class="midText"
                                        style="color:#000;font-family:'Arial';font-size:14px;font-weight:400;line-height:22px;text-align:left;padding:0;margin:0;padding-right: 0px;">
                                        If you did not initiate this password reset, please contact us.</p>
                                </td>
                            </tr>

                            <tr>
                                <td style="padding-bottom: 20px; text-align: center;display: block;">
                                    <a style="text-decoration:none;color: #fff; " href="{{ route('get.contact-us') }}">
                                        <h4
                                            style="font-size: 16px;color: #fff;margin-top: 10px;margin-bottom: 0; font-weight: 600;background: #001d38;border-radius: 5px;padding: 10px 30px;display: inline-block;font-family:'Arial';">
                                            Report</h4>
                                    </a>
                                </td>
                            </tr>
