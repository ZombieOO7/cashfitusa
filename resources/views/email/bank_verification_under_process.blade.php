		...
		<td align="center">
			<table style="background: #fff" width="600" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff"> 				
					<tbody bgcolor="#ebebeb">
						...
						<tr>
							<td style="padding-bottom:50px; padding-top: 20px;" class="imgPost" valign="top" align="center"><a href="#" style="text-decoration:none"><img alt="banner" src="{{asset('email/bank-verifi-under-pro-banner.png')}}" style="max-width:800px;height:auto;display:block" border="0"></a></td>
						</tr>


						<tr>
							<td style="padding-bottom:150px;padding-left:30px;padding-right:30px;padding-top: 20px;" class="title" valign="top" align="left">
								<h4 class="bigTitle" style="color:#000;font-family:'Arial';font-size:21px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:24px;text-align:left;padding-bottom: 30px; margin:0"><strong>Hi {{@$display_name}},</strong>
								</h4>
								<p class="midText" style="color:#000;font-family:'Arial';font-size:14px;font-weight:400;line-height:22px;text-align:left;padding:0;margin:0;padding-right: 0px; margin-bottom: 20px;">The Bank details provided by you is under process of verification. Once our Rapid Cash America Verification Team successfully verifies your Bank details you will be notified.</p>
								<p class="midText" style="color:#000;font-family:'Arial';font-size:14px;font-weight:400;line-height:22px;text-align:left;padding:0;margin:0;padding-right: 0px;">This process ensures that the bank details provided by the user is Valid and Legal in all terms.</p>
							</td>
						</tr>
