		...
		<td align="center">
			<table style="background: #fff" width="600" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff"> 				
					<tbody bgcolor="#ebebeb">
						...
						<tr>
							<td style="padding-bottom:50px; padding-top: 20px;" class="imgPost" valign="top" align="center"><a href="#" style="text-decoration:none"><img alt="banner" src="{{asset('email/bank-verifi-rejec-banner.png')}}" style="max-width:800px;height:auto;display:block" border="0"></a></td>
						</tr>
						...
						<tr>
							<td style="padding-bottom:0px;padding-left:30px;padding-right:30px;padding-top: 20px;" class="title" valign="top" align="left">
								...
								<p class="midText" style="color:#000;font-family:'Arial';font-size:14px;font-weight:400;line-height:22px;text-align:left;padding:0;margin:0;padding-right: 0px;">The Bank Details submitted by you for the verification of the process has been rejected. During the verification of the procedure our Rapid Cash America’s Verification Team found out that there is something missing / Invalid in the Bank Details you have submitted.</p>
							</td>
						</tr>
						<tr>
							<td style="padding-bottom: 150px; text-align: center;display: block;">
								<h4 style="font-size: 28px;color: #fff;margin-top: 10px;margin-bottom: 0; font-weight: 600;background: #00a05e;border-radius: 5px;padding: 4px 8px;display: inline-block;font-family:'Arial';"><a style="text-decoration:none;color: #fff; " href="{{route('link.bank',['id'=>@$objectData->uuid])}}">Re-Submit</a></h4>
							</td>
						</tr>
