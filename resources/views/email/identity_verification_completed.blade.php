		...
		<td align="center">
			<table style="background: #fff" width="600" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff"> 				
					<tbody bgcolor="#ebebeb">
						...
						<tr>
							<td style="padding-bottom: 100px; text-align: center;display: block;">
								<a style="text-decoration:none;color: #fff; " href="{{ route('account-verification',['id'=>@$objectData->uuid]) }}"><h4 style="font-size: 24px;color: #fff;margin-top: 10px;margin-bottom: 0; font-weight: 600;background: #00a05e;border-radius: 5px;padding: 4px 8px;display: inline-block;font-family:'Arial';">Continue</h4></a>
							</td>
						</tr>
