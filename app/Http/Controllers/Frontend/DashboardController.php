...
class DashboardController extends Controller
{
    ...
    public function wallet(){
        ...
        $walletTransactions = WithdrawTransaction::where('user_id',$user->id)->orderBy('date','desc')->limit(10)->get();
        return view('frontend.wallet',['wallet'=>@$wallet,'user'=>@$user,'walletTransactions'=>@$walletTransactions]);
    }
}
